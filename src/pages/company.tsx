            ...
            <div className="Section__layout">
              ...
              <section className="Copy variant--Section">
                ...
                <div className="Copy__body">
                  ...
                  and invoices—and view detailed financial reports—directly from
                  the Dashboard. Stripe doesn’t limit the number of team members
                  you can add and supports granular roles and permissions to
                  help manage access.
                </div>
